...
export const metadata = {
  title: "Home",
  description:
    "Repair Junction offers fast and reliable AC, refrigerator and washing machine repair services.",
};
      ...
      <main className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href="/services"
              className="rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 text-sm font-semibold text-white shadow-lg hover:from-blue-700 hover:to-purple-700"
            >
              Our Services
            </Link>
            ...
            <Link
              href="/contact"
              className="text-sm font-semibold text-gray-900 dark:text-white hover:text-blue-600"
            >
              Contact Us →
            </Link>
          </div>
        ...
        <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg flex flex-col items-center text-center">
